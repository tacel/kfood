...
export default function KFOODCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setAddr(initialValues.addr);
    setCusn(initialValues.cusn);
    setDsc(initialValues.dsc);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new KFOOD(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "KFOODCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
